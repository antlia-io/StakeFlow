...
import { ERROR, DEPOSIT_EXPERIMENTAL_VAULT, DEPOSIT_EXPERIMENTAL_VAULT_RETURNED, DEPOSIT_ALL_EXPERIMENTAL_VAULT, DEPOSIT_ALL_EXPERIMENTAL_VAULT_RETURNED, CLAIM_EXPERIMENTAL_VAULT, CLAIM_EXPERIMENTAL_VAULT_RETURNED, ZAP_EXPERIMENTAL_VAULT, ZAP_EXPERIMENTAL_VAULT_RETURNED } from '../../constants';
...
class Asset extends Component {
  ...
  render() {
    ...
    const { amount, amountError, loading } = this.state;
    return (
        ...
        <div className={classes.actionsContainer}>
          <div className={classes.tradeContainer}>
            ...
            <div className={classes.scaleContainer}>
              ...
              <Button
                className={classes.scale} MuiCircularProgress
                variant='text'
                disabled={loading}
                color="primary"
