...
import { ERROR, GET_BALANCES, BALANCES_RETURNED, CONNECTION_CONNECTED, CONNECTION_DISCONNECTED, ZAP, ZAP_RETURNED, GET_CURV_BALANCE, GET_CURV_BALANCE_RETURNED, SWAP, SWAP_RETURNED, TRADE, TRADE_RETURNED, GET_BEST_PRICE, GET_BEST_PRICE_RETURNED } from '../../constants';
...
class Zap extends Component {
  ...
  render() {
    ...
    const { assets, curveContracts, sendAsset, sendAmount, receiveAsset, account, loading, snackbarMessage, bestPrice } = this.state;
    if (!account || !account.address) {
      return (
