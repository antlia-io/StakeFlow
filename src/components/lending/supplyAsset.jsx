...
import { Typography, TextField, Button, Accordion, AccordionSummary, AccordionDetails, Switch } from '@material-ui/core';
import BigNumber from 'bignumber.js';
import { ERROR, LENDING_SUPPLY, LENDING_SUPPLY_RETURNED, LENDING_WITHDRAW, LENDING_WITHDRAW_RETURNED, LENDING_ENABLE_COLLATERAL, LENDING_ENABLE_COLLATERAL_RETURNED, LENDING_DISABLE_COLLATERAL, LENDING_DISABLE_COLLATERAL_RETURNED } from '../../constants';
...
class SupplyAsset extends Component {
  ...
  _renderActions = () => {
    ...
    const { supplyAmount, supplyAmountError, withdrawAmount, withdrawAmountError, loading } = this.state;
