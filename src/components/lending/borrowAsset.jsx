...
import { ERROR, LENDING_BORROW, LENDING_BORROW_RETURNED, LENDING_REPAY, LENDING_REPAY_RETURNED } from '../../constants';
...
class BorrowAsset extends Component {
  ...
  _renderActions = () => {
    ...
    const { borrowAmount, borrowAmountError, repayAmount, repayAmountError, loading } = this.state;
    let theLimitUsed = 0
    if (limit === 0) {
      theLimitUsed = 0
