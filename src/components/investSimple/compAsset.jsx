...
import { ERROR, BALANCER_CLAIM, BALANCER_CLAIM_RETURNED, BALANCER_DEPOSIT, BALANCER_DEPOSIT_RETURNED, BALANCER_WITHDRAW, BALANCER_WITHDRAW_RETURNED } from '../../constants';
...
class Asset extends Component {
  ...
  render() {
    ...
    const { account, amount, amountError, redeemAmount, redeemAmountError, loading } = this.state;
