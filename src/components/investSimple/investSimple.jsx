...
import { ERROR, GET_BALANCES_LIGHT, BALANCES_LIGHT_RETURNED, INVEST_RETURNED, REDEEM_RETURNED, CONNECTION_CONNECTED, CONNECTION_DISCONNECTED } from '../../constants';
...
class InvestSimple extends Component {
  ...
  render() {
    ...
    const { loading, account, snackbarMessage, value } = this.statel
    if (!account || !account.address) {
      return (
