...
import { ERROR, GET_BALANCES, BALANCES_RETURNED, CONNECTION_CONNECTED, CONNECTION_DISCONNECTED, IDAI, IDAI_RETURNED } from '../../constants';
...
class IDai extends Component {
  ...
  render() {
    ...
    const { assets, curveContracts, sendAsset, sendAmount, receiveAsset, account, loading, modalOpen, modalBuiltWithOpen, snackbarMessage } = this.state;
    return (
