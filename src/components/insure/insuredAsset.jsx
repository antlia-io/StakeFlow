...
import { ERROR, BUY_INSURANCE, BUY_INSURANCE_RETURNED, CLAIM_INSURANCE, CLAIM_INSURANCE_RETURNED, MINT_INSURANCE, MINT_INSURANCE_RETURNED, CALCULATE_INSURANCE_COST, CALCULATE_INSURANCE_COST_RETURNED, GET_ETH_PRICE_RETURNED, GET_ETH_BALANCE_RETURNED, CALCULATE_MAX_TOKENS, CALCULATE_MAX_TOKENS_RETURNED } from '../../constants';
...
class Asset extends Component {
  ...
  render() {
    ...
    const { account, amount, amountError, ethAmount, ethAmountError, loading, pricePerInsurance, ethPrice, ethBalance, maxTokens } = this.state;
    let yearlyPremium = 0
